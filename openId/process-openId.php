<?php
    ...
    $steam_api_key = 'CHANGE_ME_BY_YOUR_WEBAPI_KEY'; // https://steamcommunity.com/dev/apikey
    ...
    $_SESSION['userData'] = [
        ...
        'privacy'=>$userData['communityvisibilitystate'],
        'datecreation'=>$userData["timecreated"],
    ];
